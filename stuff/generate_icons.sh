...
SOURCE="/Users/altan/Documents/Oracle.Bill/stuff/1024x app icon.png"
DEST_DIR="/Users/altan/Documents/Oracle.Bill/Oracle.Bill/Assets.xcassets/AppIcon.appiconset"

# Ensure the destination directory exists
mkdir -p "$DEST_DIR"

echo "Generating resized icons from source: $SOURCE"
...
sips -z 1024 1024 "$SOURCE" --out "$DEST_DIR/icon_1024x1024.png"
